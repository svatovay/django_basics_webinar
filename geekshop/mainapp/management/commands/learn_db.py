...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        action_1__price = When(action_1__condition, then=F('product__price') * F('quantity') * action_1_discount)
        action_2__price = When(action_2__condition, then=F('product__price') * F('quantity') * action_2_discount)
